...
public abstract class TrafficLights implements Timer, Utilities , Runnable{
	...
	/**
	 * Triggered to stop traffic lights from working
	 * @param stop
	 */
	public static void setStop(boolean stop) {
		TrafficLights.stop = stop;
	}
	...
	/**
	 * Increase work time and change traffics' light
	 */
	@Override
	...
	/**
	 * Compare to traffic lights objects
	 * @param obj
	 * @return boolean
	 */
	@Override
